    ...
    return (
        <footer class = 'footer-wrap'>
            <div class = 'footer-items-grid'>
                ...
                <div class = 'footer-copyright grid-item'>
